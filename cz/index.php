                ...
                <div class="sixteen columns alpha omega">
                    ...
                    <div id="mainmenu" class="pull-left">
                      <ul class="nav">
                        ...
                        <li class="two column _frame menuproducts alpha omega"><a href="#products" class="scrollit target-product menulink" title="">PRODUKTY</a></li>
                        <li class="two column _frame menuclients alpha omega"><a href="#clients" class="scrollit target-clients menulink" title="">KLIENTI</a></li>
...
<script>
  ...
  ga('create', 'UA-49279374-1', 'truhlarstvisvr.eu');
  ga('send', 'pageview');
