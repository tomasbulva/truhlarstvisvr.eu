...
<body>
                ...
                <div class="sixteen columns alpha omega">
                    ...
                    <div id="langmenu" class="pull-right">
                      <ul class="nav">
                        ...
                        <li class="two column _frame alpha omega active"><a href="<?php echo $webroot; ?>/fr" class="target-login" title="">FR</a></li>
                      </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="section top frame_ full-width" id="top">
            <div class="container frame_ topcontent">
                <div class="sixteen columns">
                    ...
                    <h1 class="special">MENUISERIE</h1>
        ...
        <div class="section mainsection footer full-width" id="contact">
                    ...
                    <div class="row">
                        <div class="eight columns alpha">
                            <p>
                              ...
                              Atelier: Nám. J. Š. Baara 11, 27374 Klobuky, <br>Česká Republika, Evropa
                            </p>
                        </div>
                        <div class="eight columns omega">
                            <p>
                            <b>Ing. Vlastimil Planicka</b><br>
							TEL +420 604 207 780, <br>EMAIL vlplst@post.cz
                            </p>
                        </div>
                    </div>
            ...
            <div class="container afterfooter">
            	<p>
	            	&copy; 2020 SVR Plánička s.r.o. Tous les droits sont réservés
            	</p>
            </div>
        </div>
