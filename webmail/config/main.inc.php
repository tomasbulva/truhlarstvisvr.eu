...
$rcmail_config['default_host'] = 'truhlarstvisvr.eu';
...
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['smtp_server'] = 'truhlarstvisvr.eu';
...
$rcmail_config['des_key'] = 'BnnhxaAmE!vMiXQO_!4AAMY9';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['username_domain'] = 'truhlarstvisvr.eu';
...
$rcmail_config['product_name'] = 'svremail';
