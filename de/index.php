...
<body>
            ...
            <div class="container frame_">
                <div class="sixteen columns alpha omega">
                    ...
                    <div id="mainmenu" class="pull-left">
                      <ul class="nav">
                        <li class="two column _frame menuabout alpha omega"><a href="#about" class="scrollit target-about menulink" title="">VON UNS</a></li>
                        <li class="two column _frame menuproducts alpha omega"><a href="#products" class="scrollit target-product menulink" title="">PRODUKTE</a></li>
                        <li class="two column _frame menuclients alpha omega"><a href="#clients" class="scrollit target-clients menulink" title="">KLIENTEL</a></li>
                        <li class="two column _frame menucontact alpha omega"><a href="#contact" class="target-contacts menulink" title="">KONTAKT</a></li>
                      </ul>
                    </div>
                    <div id="langmenu" class="pull-right">
                      <ul class="nav">
                        ...
                        <li class="two column _frame alpha omega active"><a href="<?php echo $webroot; ?>/de/" class="target-login" title="">DE</a></li>
        ...
        <div class="section top frame_ full-width" id="top">
            <div class="container frame_ topcontent">
                <div class="sixteen columns">
                    ...
                    <h1 class="special">DIE SCHREINEREI</h1>
            ...
            <div class="container frame_ vlasta-bgr">
				<div class="row">
	                <div class="eight columns offset-by-eight">
	                	<div class="text">
							<p>SVR ist eine Familientischlerei mit einer über 20 Jährigen Tradition. Unsere Firma ist bereit alle Kundenwünsche zu erfüllen, egal ob es sich um ein Einfachfenster, Euro-Fenster, Türen, Repliken historischer Fenster / Türen, Treppen, Möbel, Restaurierungen und Repliken von historischen Tischlerarbeiten handelt.</p>

							<p>Wir können Ihnen helfen, Ihre Vorstellungen zu realisieren, egal ob sich um ein Bild oder nur um eine Vision handelt. Wir können für Sie auch einen Entwurf oder technische Zeichnung erstellen, je nach Aufwand, wie kompliziert das Projekt ist. Unsere Mitarbeiter sind qualifizierte Profis der höchsten Qualität. Alle unsere Projekte sind aus Materialien der besten Qualität und mit der besten Technologie verarbeitet. Unsere Gesellschaft schätzt sehr die Umwelt, deswegen werden alle unsere Werkstätten und Lackierereien mit erneuerbaren Energien betrieben, und entsprechen den höchsten europäischen Standarten. Bei uns bekommen Sie eine individuelle Behandlung und Ihre Aufträge werden zu Ihrer Zufriedenheit durchgeführt.</p>

							<p class="desc">Der Errichter: Ing. Vlastimil Planicka</p>
	                	</div>
	                </div>
				</div>
            </div>
        ...
        <div class="section mainsection footer full-width" id="contact">
                    ...
                    <div class="row">
                        <div class="eight columns alpha">
                            <p>
                              ...
                              Werkstatt: Nám. J. Š. Baara 11, 27374 Klobuky, <br>Česká Republika, Evropa
                            </p>
                        </div>
            ...
            <div class="container afterfooter">
            	<p>
	            	&copy; 2020 SVR Plánička s.r.o. Alle Rechte vorbehalten
            	</p>
            </div>
        </div>
